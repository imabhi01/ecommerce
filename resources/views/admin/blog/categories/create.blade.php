...
@section('page-title', 'Add New Blog Category')
...
<div class="mb-6">
    ...
    <h2 class="text-2xl font-bold text-gray-800">Add New Blog Category</h2>
</div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 space-y-6">
            ...
            <div>
                ...
                <input type="text" 
                       ...
                       value="{{ old('name') }}"
                       required
                       placeholder="e.g., Productivity, Self-Improvement, Technology"
            ...
            <div class="flex space-x-4 pt-6 border-t">
                ...
                <a href="{{ route('admin.blog.categories.index') }}" class="bg-gray-200 text-gray-700 px-8 py-3 rounded-lg hover:bg-gray-300 font-semibold">
                Cancel
                </a>
            </div>
        </div>
