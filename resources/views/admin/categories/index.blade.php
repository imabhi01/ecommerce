...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="p-6">
            ...
            <div class="flex space-x-2 pt-4 border-t">
                ...
                <form action="{{ route('admin.categories.destroy', $category) }}" 
                      method="POST" 
                      onsubmit="return confirm('Are you sure? This will fail if products exist in this category.');"
                      class="flex-1">
                    @csrf
                    @method('DELETE')
                    <button type="submit" 
    ...
    <div class="col-span-full">
        <div class="bg-white rounded-lg shadow-md p-12 text-center">
            ...
            <h2 class="text-2xl font-semibold mb-4">No categories found</h2>
            <p class="text-gray-600 mb-8">Start organizing your products by creating categories</p>
            <a href="{{ route('admin.categories.create') }}" 
